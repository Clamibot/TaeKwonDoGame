...
/**
 * This class is the game's graphics engine. Each graphics instance gets its own thread.
...
public class GUI extends Thread
{
    ...
    private WindowListener exitListener = new WindowAdapter()
    {
        ...
        {
            int confirm = JOptionPane.showOptionDialog(null, "Are You Sure You Want To Exit The Game?", "Exit Confirmation", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, null, null);
            if (confirm == 0)
            {
    ...
    public void run()
    {
        while(done == 0)
        {
            try
            {
                //Have the graphics thread run until the program is terminated or the thread is signaled to halt execution.
    ...
    */
    public void ActivateMouseListeners()
    {
        ...
        main_menu_button.addMouseListener(new MouseAdapter()
        {
            ...
            {
                int confirm = JOptionPane.showOptionDialog(null, "Are You Sure You Want To Return To The Main Menu? You Will Lose All Progress.", "Exit Confirmation", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, null, null);
                if (confirm == 0)
                {
    ...
    public void DisplayMainMenu(boolean displayIntroText)
    {
        ...
        if (displayIntroText)
        {
            try
            {
                ...
                //This fixes a bug with the text output box in the event players click on a button before all the intro text is displayed.
    ...
    */
    public void DisplayKata1()
    {
        ...
        JLabel step1 = new JLabel("1. Step Into A ____ Side Fighting Stance Facing Your Left, Say ___, And Do A _______ Punch.");
        ...
        JLabel step6 = new JLabel("6. Step Into A ____ Side Fighting Stance Facing Your Left, Do A _____ Kick, Then A _______ Punch.");
        step6.setFont(new Font("sansserif",0,14));
        step6.setBounds(760, 175, 640, 20);
        JLabel step7 = new JLabel("7. Step Into A ____ Side Fighting Stance Facing Your Right, Do A _____ Kick, Then A _______ Punch.");
        step7.setFont(new Font("sansserif",0,14));
        step7.setBounds(760, 200, 740, 20);
        JLabel step8 = new JLabel("8. Step Into A ____ Side Fighting Stance Facing The Back, Do A _____ Kick, Then A _______ Punch.");
        step8.setFont(new Font("sansserif",0,14));
        step8.setBounds(760, 225, 660, 20);
        JLabel step9 = new JLabel("9. Step Into A ____ Side Fighting Stance Facing The Front, Do A ________ _____ Kick, Then A _______ Punch.");
        step9.setFont(new Font("sansserif",0,14));
        step9.setBounds(760, 250, 740, 20);
        JLabel step10 = new JLabel("10. Step Into A ____ Side Fighting Stance Facing The Back, Do A ________ _____ Kick, Then A _______ Punch.");
    ...
    */
    public void DisplayKata2()
    {
        ...
        //List the steps with some parts missing
        JLabel step1 = new JLabel("1. Fold For A ___ Block, Step Into A ____ Side Forebalance Facing Your Left, Do A ___ Block, And Say ___.");
        step1.setFont(new Font("sansserif",0,14));
        step1.setBounds(780, 50, 720, 20);
        JLabel step2 = new JLabel("2. Point Forward With The Same Arm you Blocked With, Step Forward With The Back Foot, And Punch.");
        step2.setFont(new Font("sansserif",0,14));
        step2.setBounds(780, 75, 720, 20);
        JLabel step3 = new JLabel("3. Fold For A ___ Block, Step Into A ____ Side Forebalance Facing Your Right, And Do A ___ Block.");
        step3.setFont(new Font("sansserif",0,14));
        step3.setBounds(780, 100, 720, 20);
        JLabel step4 = new JLabel("4. Point Forward With The Same Arm you Blocked With, Step Forward With The Back Foot, And Punch.");
        step4.setFont(new Font("sansserif",0,14));
        step4.setBounds(780, 125, 720, 20);
        JLabel step5 = new JLabel("5. Fold For A ___ Block, Step Into A ____ Side Forebalance Facing The Front, And Do A ___ Block.");
        step5.setFont(new Font("sansserif",0,14));
        step5.setBounds(780, 150, 720, 20);
        JLabel step6 = new JLabel("6. Point Forward With The Same Arm you Blocked With, Step Forward With The Back Foot, And Punch.");
        step6.setFont(new Font("sansserif",0,14));
        step6.setBounds(780, 175, 660, 20);
        JLabel step7 = new JLabel("7. Fold For A ___ Block, Step Into A ____ Side Forebalance Facing The Back, And Do A ___ Block.");
        step7.setFont(new Font("sansserif",0,14));
        step7.setBounds(780, 200, 660, 20);
        JLabel step8 = new JLabel("8. Point Forward With The Same Arm you Blocked With, Step Forward With The Back Foot, Punch, Then Say ___.");
        step8.setFont(new Font("sansserif",0,14));
        step8.setBounds(780, 225, 760, 20);
        JLabel step9 = new JLabel("9. Do A _____ Block Into A ____ Side Fighting Stance Facing Your Left, Point Forward, Step Forward Into A Forebalance, And Punch.");
        step9.setFont(new Font("sansserif",0,14));
        step9.setBounds(780, 250, 760, 20);
        JLabel step10 = new JLabel("10. Do A _____ Block Into A ____ Side Fighting Stance Facing Your Right, Point Forward, Step Forward Into A Forebalance, And Punch.");
        step10.setFont(new Font("sansserif",0,14));
        step10.setBounds(780, 275, 760, 20);
        JLabel step11 = new JLabel("11. Do A _____ Block Into A ____ Side Fighting Stance Facing The Back, Point Forward, Step Forward Into A Forebalance, And Punch.");
        step11.setFont(new Font("sansserif",0,14));
        step11.setBounds(780, 300, 760, 20);
        JLabel step12 = new JLabel("12. Do A _____ Block Into A ____ Side Fighting Stance Facing The Front, Point Forward, Step Forward Into A Forebalance, And Punch.");
    ...
    */
    public void DisplayKata3()
    {
        ...
        JLabel step6 = new JLabel("6. Point Forward, Step Forward And Punch, Step Forward And Punch Again, Step Forward And Punch A Third Time, Then Say ___.");
        step6.setFont(new Font("sansserif",0,14));
        ...
        step8.setFont(new Font("sansserif",0,14));
        step8.setBounds(780, 225, 760, 20);
        JLabel step9 = new JLabel("9. Do A ___ Block To The Other Side, Point And Chamber, Step Forward Into A _____ Side Forebalance, And Punch.");
        step9.setFont(new Font("sansserif",0,14));
        step9.setBounds(780, 250, 760, 20);
        ...
        step15.setFont(new Font("sansserif",0,14));
        step15.setBounds(780, 400, 660, 20);
        JLabel step16 = new JLabel("16. Close Your Hand Into A Fist, Then Step Forward And Punch In A _____ Side Forebalance.");
        ...
        JLabel step18 = new JLabel("18. Close Your Hand Into A Fist, Then Step Forward And Punch In A ____ Side Forebalance.");
    ...
    */
    public void DisplayKata4()
    {
        ...
        //List the steps with some parts missing
        JLabel step1 = new JLabel("1. Step Into A ____ Side Forebalance Facing Your Left, Do A ______ Block, And Say ___.");
        step1.setFont(new Font("sansserif",0,14));
        step1.setBounds(780, 50, 620, 20);
        JLabel step2 = new JLabel("2. Punch In Place.");
        step2.setFont(new Font("sansserif",0,14));
        step2.setBounds(780, 75, 620, 20);
        JLabel step3 = new JLabel("3. Rotate To The Other Side By Taking 2 Steps Over And Do A ______ Block In A _____ Side Forebalance.");
        step3.setFont(new Font("sansserif",0,14));
        step3.setBounds(780, 100, 620, 20);
        ...
        JLabel step8 = new JLabel("8. Backfist With The Left Hand, Step Forward, Backfist With The Right Hand, And Say ___.");
        step8.setFont(new Font("sansserif",0,14));
        ...
        JLabel step11 = new JLabel("11. Rotate To The Other Side By Taking 2 Steps Over And Do A ______ Block In A _____ Side Forebalance.");
        step11.setFont(new Font("sansserif",0,14));
        step11.setBounds(780, 300, 620, 20);
        JLabel step12 = new JLabel("12. Punch In Place.");
        step12.setFont(new Font("sansserif",0,14));
        step12.setBounds(780, 325, 620, 20);
        JLabel step13 = new JLabel("13. Step Into A ____ Side Forebalance At A 45 Degree Angle Offset To The Left Relative To The Back And Do A _____ Block.");
        step13.setFont(new Font("sansserif",0,14));
        step13.setBounds(780, 350, 620, 20);
        JLabel step14 = new JLabel("14. Bring The Right Hand Back, Do A Rear Leg Front Kick, And Set It Down In Front Of You.");
        step14.setFont(new Font("sansserif",0,14));
        step14.setBounds(780, 375, 620, 20);
        JLabel step15 = new JLabel("15. Punch Twice In the Air.");
        step15.setFont(new Font("sansserif",0,14));
        step15.setBounds(780, 400, 620, 20);
        JLabel step16 = new JLabel("16. Step Into A ____ Side Forebalance At A 45 Degree Angle Offset To The Right Relative To The Back And Do A _____ Block.");
        step16.setFont(new Font("sansserif",0,14));
        step16.setBounds(780, 425, 620, 20);
        JLabel step17 = new JLabel("17. Bring The Left Hand Back, Do A Rear Leg Front Kick, And Set It Down In Front Of You.");
        step17.setFont(new Font("sansserif",0,14));
        ...
        JLabel step22 = new JLabel("22. Fold For Another Chop, Slide Your Feet Together, Slide To The Right, Chop, And Say ___.");
    ...
    */
    public void DisplayKata5()
    {
        ...
        step1.setFont(new Font("sansserif",0,14));
        step1.setBounds(780, 50, 620, 20);
        JLabel step2 = new JLabel("2. Step into a ____ side fighting stance facing your left, do a ___ block, and say ___.");
        step2.setFont(new Font("sansserif",0,14));
        step2.setBounds(780, 75, 620, 20);
        ...
        step11.setFont(new Font("sansserif",0,14));
        step11.setBounds(780, 300, 620, 20);
        JLabel step12 = new JLabel("12. Fold for a ___ block, spin 270 degrees towards your left, and thrust the block up.");
        step12.setFont(new Font("sansserif",0,14));
        step12.setBounds(780, 325, 620, 20);
        ...
        step17.setFont(new Font("sansserif",0,14));
        step17.setBounds(780, 450, 620, 20);
        JLabel step18 = new JLabel("18. Step into a ____ side forebalance facing the back and do a windmill _____ block.");
        step18.setFont(new Font("sansserif",0,14));
        step18.setBounds(780, 475, 620, 20);
        ...
        JLabel step24 = new JLabel("24. Spin 90 degrees towards your left and land in a ____ side fighting stance facing your left.");
    ...
    */
    public void DisplayKata6()
    {
        ...
        step9.setFont(new Font("sansserif",0,14));
        step9.setBounds(780, 250, 620, 20);
        JLabel step10 = new JLabel("10. Turn 45 degrees to the right with the front foot and face the front in a forebalance.");
        step10.setFont(new Font("sansserif",0,14));
        step10.setBounds(780, 275, 620, 20);
        ...
        step17.setFont(new Font("sansserif",0,14));
        step17.setBounds(780, 450, 620, 20);
        JLabel step18 = new JLabel("18. Do a _________ box block to the left in a fighting stance, then step forward and spear in a ___________.");
        step18.setFont(new Font("sansserif",0,14));
        step18.setBounds(780, 475, 620, 20);
        JLabel step19 = new JLabel("19. Do a _________ box block to the right in a fighting stance, then step forward and spear in a ___________.");
        step19.setFont(new Font("sansserif",0,14));
        step19.setBounds(780, 500, 620, 20);
    ...
    */
    public void DisplayKata7()
    {
        ...
        step1.setFont(new Font("sansserif",0,14));
        step1.setBounds(780, 50, 620, 20);
        JLabel step2 = new JLabel("2. Do a palm strike to your left with the left hand in a left side ___ stance and say ___.");
        step2.setFont(new Font("sansserif",0,14));
        ...
        JLabel step12 = new JLabel("12. Step forward and do a double punch, then step forward and do a double palm strike.");
        step12.setFont(new Font("sansserif",0,14));
        ...
        JLabel step17 = new JLabel("17. Step out into a ____ side forebalance, wrap with the front arm, then do a _______ punch.");
        step17.setFont(new Font("sansserif",0,14));
        ...
        JLabel step19 = new JLabel("19. Step out into a ____ side forebalance, wrap with the front arm, then do a _______ punch.");
        step19.setFont(new Font("sansserif",0,14));
        step19.setBounds(780, 410, 620, 20);
        JLabel step20 = new JLabel("20. Fold for a Tsong-Su block.");
        step20.setFont(new Font("sansserif",0,14));
        step20.setBounds(780, 430, 620, 20);
        JLabel step21 = new JLabel("21. Slide your feet together, step out into a ____ side forebalance, then do a ________ block.");
        step21.setFont(new Font("sansserif",0,14));
