...
public class Green1 extends javax.swing.JPanel {
            ...
            if (index == answer.length)
            {
                ...
                switch (choice)
                {
                    ...
                    case 2:
                        ...
                        Main.display.kataContentPane.add(new Blue1());
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("1. Go into position for the kata.\n2. Step into a ____ side fighting stance facing your left, do a ___ block, and say ___.\n3. Chop with the top hand, and protect with the front hand simultaneously.\n4. Chamber on the front hip and punch with the front hand.\n5. Step into a _____ side fighting stance facing your right and do a ___ block.\n6. Chop with the top hand, and protect with the front hand simultaneously.\n7. Chamber on the front hip and punch with the front hand.\n8. Do a come-around ____ kick to the front and land in a ______ block.\n9. Step forward and do another ______ block.\n10. Step forward once more and do a ______ block.\n11. Step forward into a forebalance and spear, then say ___.\n12. Fold for a ___ block, spin 27degrees towards your left, and thrust the block up.\n13. Chop with the top hand, and protect with the front hand simultaneously.\n14. Chamber on the front hip and punch with the front hand.\n15. Step into a _____ side fighting stance facing your right and do a ___ block.\n16. Chop with the top hand, and protect with the front hand simultaneously.\n17. Chamber on the front hip and punch with the front hand.\n18. Step into a ____ side forebalance facing the back and do a windmill _____ block.\n19. Do a rear leg front kick and set it down in front of you.\n20. Punch with the left arm, then do a _____ block with it.\n21. Do another rear leg front kick and set it down in front of you.\n22. Punch with the right arm.\n23. Do a come-around ____ kick to the back.\n24. Spin 90 degrees towards your left and land in a ____ side fighting stance facing your left.\n25. Switch to a _____ side fighting stance facing your right and say ___.\n26. Go back to position after waiting seconds.\n");
