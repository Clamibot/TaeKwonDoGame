 ...
 * @author MasterWard
 */
public class Blue2 extends javax.swing.JPanel {
            ...
            if (index == answer.length)
            {
                ...
                switch (choice)
                {
                    ...
                    case 2:
                        ...
                        Main.display.kataContentPane.add(new Red1());
